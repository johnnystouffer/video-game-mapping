const mapData = [
    {
        ...
        buttons: [['Checkpoints','checkpoints','src/assets/checkpoint.png'], ['Power Moons','power-moons','src/assets/power-moons/power-moon-yellow.png'], ['Multi-Moons','multimoons','src/assets/multimoons/multimoon-yellow.webp'], ['Purple Coins','purple-coins','src/assets/purple-coins/cap-coin.png'], ['Bonus Areas','spec-area','src/assets/pipe.png']],
        mapImage: 'src/assets/maps/cap-kingdom.png'
    },
    {
        id: 'cascade-kingdom', 
        ...
        buttons: [['Checkpoints','checkpoints','src/assets/checkpoint.png'], ['Power Moons','power-moons','src/assets/power-moons/power-moon-yellow.png'], ['Multi-Moons','multimoons','src/assets/multimoons/multimoon-yellow.webp'], ['Purple Coins','purple-coins','src/assets/purple-coins/cascade-coin.png'], ['Bonus Areas','spec-area','src/assets/pipe.png']],
    ...
    },
    {
        ...
        buttons: [['Checkpoints','checkpoints','src/assets/checkpoint.png'], ['Power Moons','power-moons','src/assets/power-moons/power-moon-green.png'], ['Multi-Moons','multimoons','src/assets/multimoons/multimoon-green.png'], ['Purple Coins','purple-coins','src/assets/purple-coins/sand-coin.png'], ['Bonus Areas','spec-area','src/assets/pipe.png']],
